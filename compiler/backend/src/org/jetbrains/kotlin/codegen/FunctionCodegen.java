...
public class FunctionCodegen {
    ...
    public static void generateParameterAnnotations(
        ...
        if (!AsmUtil.IS_BUILT_WITH_ASM6 && syntheticParameterCount > 0) {
            mv.visitAnnotableParameterCount(kotlinParameterTypes.size() - syntheticParameterCount, true);
            mv.visitAnnotableParameterCount(kotlinParameterTypes.size() - syntheticParameterCount, false);
        }
    }
